export default function Pagination() {
	return (
		<>
			<div class="flex items-center justify-between border-t border-gray-200 bg-white pt-8">
				...
				<div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
					...
					<div>
						<nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
							...
							<a href="#" aria-current="page" class="relative z-10 inline-flex items-center border border-blue-500 bg-indigo-50 px-4 py-2 text-sm font-medium text-blue-600 focus:z-20">1</a>
